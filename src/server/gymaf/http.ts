...
export async function rpc(name: "gymaf_register_session" | "gymaf_revoke_session" | "gymaf_query" | "gymaf_command" | "gymaf_public_coach" | "gymaf_member_query" | "gymaf_member_command" | "gymaf_training_query" | "gymaf_training_command", args: Record<string, unknown>, token?: string): Promise<unknown> { return provider(`/rest/v1/rpc/${name}`, args, token); }
